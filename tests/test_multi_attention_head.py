...
from multi_head_attention import MultiHeadAttention  # Adjust based on your file structure


@pytest.mark.parametrize("batch_size, seq_len, model_ckpt", [
    (2, 10, "bert-base-uncased"),  # Test case 1: BERT-base
    (4, 20, "distilbert-base-uncased")  # Test case 2: BERT-large
])
